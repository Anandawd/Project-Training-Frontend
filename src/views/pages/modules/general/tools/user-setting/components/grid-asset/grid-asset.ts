...
import SearchFilter from "@/views/pages/components/filter/filter";
...
export default class GridAsset extends Vue {
  public rowData: any = [];
  ...
  beforeMount() {
    ...
    this.searchOptions = [
      { text: this.$t("commons.filter.folioNumber"), value: 0 },
      { text: this.$t("commons.filter.roomNumber"), value: 1 },
      { text: this.$t("commons.filter.guestName"), value: 2 },
