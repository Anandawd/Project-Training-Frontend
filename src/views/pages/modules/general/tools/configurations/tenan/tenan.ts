...
const resourceAPI = new ConfigurationResource("Tenan");
...
export default class Tenan extends Vue {
  public rowData: any = [];
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.posCfgInitTenan,
            this.paramsData.id
          ),
      },
    ];
  ...
  async editData(code: any) {
    try {
      ...
      this.form = data;
      this.form.birthday = formatDateDatabase(this.form.birthday);
  ...
  async loadDropdown() {
    try {
      const { data } = await resourceAPI.codeNameList("Owner");
      this.inputFormElement.listDropdown.owner = data;
    } catch (error) {
      getError(error);
    }
  }
  ...
  beforeMount() {
    ...
    this.searchOptions = [
      ...
      { text: this.$t("commons.filter.owner"), value: 2 },
      { text: this.$t("commons.filter.street"), value: 3 },
      { text: this.$t("commons.filter.city"), value: 4 },
      { text: this.$t("commons.filter.phone1"), value: 5 },
      { text: this.$t("commons.filter.phone2"), value: 6 },
    ...
    this.columnDefs = [
      ...
      {
        headerName: this.$t("commons.table.commission"),
        field: "commission",
        width: 100,
      ...
      {
        headerName: this.$t("commons.table.street"),
        field: "street",
        width: 180,
      },
      {
        headerName: this.$t("commons.table.city"),
        field: "city",
        width: 150,
      },
      {
        headerName: this.$t("commons.table.phone1"),
        field: "phone1",
        width: 100,
      },
      {
        headerName: this.$t("commons.table.phone2"),
        field: "phone2",
        width: 100,
      },
      {
