...
const resourceAPI = new ConfigurationResource("SalesTaskAction");
...
export default class SalesTaskAction extends Vue {
  public rowData: any = [];
  ...
  beforeMount() {
    ...
    this.columnDefs = [
      ...
      { headerName: this.$t("commons.table.name"), field: "name", width: 80 },
