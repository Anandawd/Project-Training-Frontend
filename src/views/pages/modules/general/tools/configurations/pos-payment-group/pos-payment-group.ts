...
const resourceAPI = new ConfigurationResource("POSPaymentGroup");
...
export default class POSPaymentGroup extends Vue {
  public rowData: any = [];
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.posCfgInitPaymentGroup,
            this.paramsData.id
          ),
      },
    ];
  ...
  async updateData(formData: any) {
    try {
      formData.account_code = this.form.account_code;
