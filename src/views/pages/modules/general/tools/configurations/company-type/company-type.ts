...
const resourceAPI = new ConfigurationResource("CompanyType");
...
export default class CompanyType extends Vue {
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            $global.tableName.cfgInitCompanyType,
            this.paramsData.id
          ),
      },
    ];
  ...
  async handleSave(formData: any) {
    ...
    formData.is_personal = parseInt(formData.is_personal);
  ...
  async loadDropdown() {
    try {
      const params = ["JournalAccountAP", "JournalAccountAR"];
  ...
  beforeMount() {
    ...
    this.searchOptions = [
      ...
      { text: this.$t("commons.filter.apAccount"), value: 2 },
      { text: this.$t("commons.filter.arAccount"), value: 3 },
    ...
    this.columnDefs = [
      ...
      {
        headerName: this.$t("commons.table.apAccount"),
        field: "APAccount",
        width: 170,
      },
      {
        headerName: this.$t("commons.table.arAccount"),
        field: "ARAccount",
        width: 170,
      },
      {
        headerName: this.$t("commons.table.personal"),
        field: "is_personal",
        width: 80,
  ...
  get schema() {
    return Yup.object().shape({
      ...
      "AP Account": Yup.string().required(),
      "AR Account": Yup.string().required(),
      "ID Sort": Yup.number(),
    });
  }
