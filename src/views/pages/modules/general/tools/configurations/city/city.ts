...
const resourceAPI = new ConfigurationResource("City");
...
export default class City extends Vue {
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.cfgInitCity,
            this.paramsData.id
          ),
      },
    ];
  ...
  beforeMount() {
    ...
    this.searchOptions = [
      ...
      { text: this.$t("commons.filter.state"), value: 2 },
      { text: this.$t("commons.filter.regency"), value: 3 },
    ...
    this.columnDefs = [
      ...
      {
        headerName: this.$t("commons.table.regency"),
        field: "RegencyName",
        width: 190,
      },
      {
