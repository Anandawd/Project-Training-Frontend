...
const resourceAPI = new ConfigurationResource("ItemCategoryOtherExpense");
...
export default class ItemCategoryOtherExpense extends Vue {
  ...
  resetForm() {
    this.otherExpenseElement.resetForm();
    this.$nextTick();
    this.form = {
  ...
  onSubmit() {
    this.otherExpenseElement.$el.requestSubmit();
  }
  ...
  get title() {
    if (this.modeData === $global.modeData.insert) {
      return `${this.$t("commons.insert")} ${this.$t(
        `${this.$t("title.otherExpenseAccount")}`
      )}`;
    } else if (this.modeData === $global.modeData.edit) {
