...
const resourceAPI = new ConfigurationResource("SpaRoom");
...
export default class SpaRoom extends Vue {
  public rowData: any = [];
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.posCfgInitSpaRoom,
            this.paramsData.id
          ),
      },
    ];
  ...
  beforeMount() {
    ...
    this.searchOptions = [
      ...
      { text: this.$t("commons.filter.description"), value: 2 },
