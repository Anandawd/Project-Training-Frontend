...
const resourceAPI = new ConfigurationResource("ReturnStockReason");
...
export default class ReturnStockReason extends Vue {
  public rowData: any = [];
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.invCfgInitReturnStockReason,
            this.paramsData.id
          ),
      },
    ];
