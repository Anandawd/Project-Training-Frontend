...
const resourceAPI = new ConfigurationResource("SalesTaskRepeat");
...
export default class SalesTaskRepeat extends Vue {
  public rowData: any = [];
  ...
  beforeMount() {
    ...
    this.columnDefs = [
      ...
      { headerName: this.$t("commons.table.name"), field: "name", width: 60 },
      {
        headerName: this.$t("commons.table.days"),
        field: "days",
        width: 60,
        cellStyle: { textAlign: "right" },
