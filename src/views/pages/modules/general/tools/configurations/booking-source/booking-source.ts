...
const resourceAPI = new ConfigurationResource("BookingSource");
...
export default class BookingSource extends Vue {
  public rowData: any = [];
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.cfgInitBookingSource,
            this.paramsData.id
          ),
      },
    ];
  ...
  beforeMount() {
    ...
    this.columnDefs = [
      ...
      { headerName: this.$t("commons.table.name"), field: "name", width: 165 },
      {
