...
const resourceAPI = new ConfigurationResource("RoomUnavailableReason");
...
export default class RoomUnavailableReason extends Vue {
  public rowData: any = [];
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.cfgInitRoomUnavailableReason,
            this.paramsData.id
          ),
      },
    ];
  ...
  beforeMount() {
    ...
    this.searchOptions = [
      ...
      { text: this.$t("commons.filter.description"), value: 1 },
