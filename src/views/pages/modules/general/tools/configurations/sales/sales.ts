...
const resourceAPI = new ConfigurationResource("Sales");
...
export default class Sales extends Vue {
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.cfgInitSales,
            this.paramsData.id
          ),
      },
    ];
  ...
  beforeMount() {
    ...
    this.searchOptions = [
      ...
      { text: this.$t("commons.filter.email"), value: 2 },
      { text: this.$t("commons.filter.phoneNumber"), value: 3 },
      { text: this.$t("commons.filter.waNumber"), value: 4 },
      { text: this.$t("commons.filter.createdBy"), value: 5 },
      { text: this.$t("commons.filter.updatedBy"), value: 6 },
    ];
    ...
    this.columnDefs = [
      ...
      {
        headerName: this.$t("commons.table.waNumber"),
        field: "wa_number",
        width: 120,
      },
      {
