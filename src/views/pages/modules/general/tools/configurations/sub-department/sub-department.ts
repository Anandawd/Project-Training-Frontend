...
const resourceAPI = new ConfigurationResource("SubDepartment");
...
export default class SubDepartment extends Vue {
  public rowData: any = [];
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            $global.tableName.cfgInitSubDepartment,
            this.paramsData.id
          ),
      },
    ];
  ...
  beforeMount() {
    ...
    this.searchOptions = [
      ...
      { text: this.$t("commons.filter.department"), value: 2 },
    ...
    this.columnDefs = [
      ...
      {
        headerName: this.$t("commons.table.isCompliment"),
        field: "is_compliment",
        width: 90,
