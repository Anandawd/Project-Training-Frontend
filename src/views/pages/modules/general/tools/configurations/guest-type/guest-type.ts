...
import ColorRenderer from "@/components/ag_grid-framework/color.vue";
import {
...
const resourceAPI = new ConfigurationResource("GuestType");
...
export default class GuestType extends Vue {
  public rowData: any = [];
  ...
  getContextMenu(params: any) {
    ...
    const result = [
      ...
      },
      {
        ...
        disabled: !this.paramsData,
        icon: generateIconContextMenuAgGrid("uplicate_icon24"),
      ...
      "separator",
      {
        ...
        action: () =>
          this.handleTrackingData(
            this.$global.tableName.cfgInitGuestType,
            this.paramsData.id
          ),
      },
    ];
  ...
  beforeMount() {
    if (this.showForm) window.scrollTo(0, 400);
    ...
    this.searchOptions = [
      ...
      { text: this.$t("commons.filter.country"), value: 2 },
    ...
    this.columnDefs = [
      ...
      { headerName: this.$t("commons.table.name"), field: "name", width: 130 },
      {
        headerName: this.$t("commons.table.color"),
        field: "color",
