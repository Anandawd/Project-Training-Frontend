    ...
    template: `
                <div v-if="params.data" class="flex action-button">
                    <vs-dropdown vs-trigger-click class="cursor-pointer">
                        ...
                        <vs-dropdown-menu>
                            <vs-dropdown-item @click="showPopUp(global.modeData.tracking)"><img border="0" width="20" height="20" src="/images/icons/tracking_icon24.png"/>{{ $t('commons.menu.trackingData') }}</vs-dropdown-item>
                            <vs-dropdown-item v-if="params.data.is_active === true || params.data.is_active === false" @click="activeDeactive()">{{ params.data.is_active == true ? $t('commons.menu.deactive') : $t('commons.menu.active') }}</vs-dropdown-item>
                        </vs-dropdown-menu>
                    </vs-dropdown>
